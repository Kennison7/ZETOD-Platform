    ...
    <footer className="border-t border-white/5 py-12 lg:py-16">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-muted text-sm leading-relaxed max-w-xs">
              Evaluating real Python skills for developers who build, not just
              certify.
            </p>
          </div>
          ...
          <div>
            ...
            <a
              href="#"
              className="inline-flex items-center gap-2 text-sm text-muted hover:text-text transition-colors duration-200"
            >
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted">&copy; 2026 ZeToD. All rights reserved.</p>
          <p className="text-xs text-muted/60">Built for developers across Africa and beyond.</p>
        </div>
      </Container>
    </footer>
  )
